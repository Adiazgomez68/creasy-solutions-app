                    ...
                    <div className="form">
                        ...
                        <Form>
                            ...
                            <Form.Group id="select">
                                ...
                                <Form.Select aria-label="Default select example" id="fs">
                                    <option selected disabled hide style={{ display: 'none' }}> Select type user </option>
                                    <option style={{background:'white'}} value="1">Student</option>
                                    <option style={{background:'white'}} value="2">Leader</option>
                                    <option style={{background:'white'}} value="3">Administrator</option>
                                </Form.Select>
                            </Form.Group>
                        </Form>
                        <Button id="btn-up" > Sign up </Button>
                    </div>
